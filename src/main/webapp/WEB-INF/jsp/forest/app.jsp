            ...
            initTable: function () {
                ...
                $('#table').bootstrapTable({
                    columns: [
                        ...
                        {field: 'topic', title: 'topic', sortable: 'true', align: 'center', width: '15%'},
                        {field: 'createBy', title: '创建时间', sortable: 'true', align: 'center', width: '15%'},
                        {field: 'status', title: '状态', sortable: 'true', align: 'center', width: '15%'},
                        {
                            field: 'serviceName',
                            title: '操作',
                            align: 'center',
